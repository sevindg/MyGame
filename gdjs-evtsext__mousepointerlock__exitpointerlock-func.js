...
gdjs.evtsExt__MousePointerLock__ExitPointerLock.userFunc0x118cff0 = function GDJSInlineCode(runtimeScene, eventsFunctionContext) {
"use strict";

const { handler } = gdjs._MousePointerLockExtension;

handler.exitPointerLock();
...
gdjs.evtsExt__MousePointerLock__ExitPointerLock.userFunc0x118cff0(runtimeScene, eventsFunctionContext);
